...
In the following exploration we consider a subset of publishers/journals which may be classified as questionable (in the following referred to as PQJs, note that in the plots below we also use subsets of this list):

* Academic Journals: massive list of journals with very small number of papers, was listed in Beall's list but made a formal appeal and considers itself unfairly treated despite its efforts (cf. https://academicjournals.org/about_us) - unclear
