...
# write_csv(ugoe_alt_metr, "/Users/bschmidt/ownCloud/data/journals/ugoe_altmetrics_20200519.csv")
#write_csv(ugoe_alt_metr, "/Users/bschmidt/ownCloud/data/OpenAPC/data_output/ugoe_altmetrics_20200519.csv")

ugoe_altmetrics <- read_csv("/Users/bschmidt/ownCloud/data/OpenAPC/data_output/ugoe_altmetrics_20200519.csv")
...
#write_csv(ugoe, "/Users/bschmidt/ownCloud/data/OpenAPC/data_output/openapc_ugoe_20200410.csv")
#write_csv(ugoe, "/Users/bschmidt/ownCloud/data/OpenAPC/data_output/openapc_ugoe_20200519.csv")

ugoe <- read_csv("/Users/bschmidt/ownCloud/data/OpenAPC/data_output/openapc_ugoe_20200519.csv")
...
ugoe_xx %>% ggplot(aes(x = period, y = cited_by_posts_count, color = WoS_idx)) + geom_boxplot(aes(group = period, color = WoS_idx), outlier.shape = NA) + geom_jitter(alpha = 0.5, width = 0.25, height = 0) + scale_y_continuous(trans = 'log10') + coord_flip() + theme_minimal() + ggtitle("Twitter mentions by publication year") + xlab("Year") + ylab("Twitter posts") + labs(fill = "Indexed by WoS")
